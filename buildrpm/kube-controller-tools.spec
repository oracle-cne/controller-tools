...
%build
go build -trimpath=false -ldflags="-X main.version=0.21.0" -o controller-gen ./cmd/controller-gen 
go build -trimpath=false -ldflags="-X main.version=0.21.0" -o helpgen ./cmd/helpgen
go build -trimpath=false -ldflags="-X main.version=0.21.0" -o type-scaffold ./cmd/type-scaffold
...
%changelog
* Wed May 06 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 0.21.0-1
